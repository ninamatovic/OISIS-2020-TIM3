...
public class AdmSpisakRecepata extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdmSpisakRecepata frame = new AdmSpisakRecepata();
	...
	public AdmSpisakRecepata() {
		...
		BtnKorisnici.setBounds(30, 290, 150, 40);
		BtnKorisnici.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		BtnKorisnici.setForeground(Color.WHITE);
		BtnKorisnici.setFont(new Font("Comic Sans MS", Font.BOLD, 19));
		BtnKorisnici.setFocusPainted(false);
		BtnKorisnici.setBackground(new Color(51, 102, 102));
		
		JButton btnProdaja = new JButton("Prodaja");
		btnProdaja.setBounds(30, 380, 150, 40);
		btnProdaja.setForeground(Color.WHITE);
		btnProdaja.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
		btnProdaja.setFocusPainted(false);
		btnProdaja.setBackground(new Color(51, 102, 102));
		
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setBounds(27, 5, 150, 112);
		lblNewLabel.setIcon(new ImageIcon(AdmSpisakRecepata.class.getResource("/Slike/LogoM.png")));
		...
		lblNewLabel_1.setBounds(217, 73, 88, 27);
		getContentPane().add(lblNewLabel_1);
		
		textField = new JTextField();
		textField.setBounds(298, 80, 298, 19);
		...
		lblNewLabel_2.setBounds(216, 20, 325, 47);
